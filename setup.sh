#!/bin/bash
# // REPO
REPO="https://raw.githubusercontent.com/rizaddin/v5/main/"
clear
restart_system() {
TIME="10"
CHATID="5094755726"
KEY="6412765782:AAGcs0UxYMo95lQHSP6XEdMDazysjoMBl7s"
...
run_ei() {
  ...
  # Link izin IP VPS
  url_izin='https://raw.githubusercontent.com/rizaddin/v5/main/izin.txt'
...
clear
      ...
      echo -e ""
      echo -e "\e[93m Telegram\e[32;1m : https://t.me/dilanjaya"
      echo -e "\e[33m ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m" | lolcat
      echo -e ""
      exit 0
    fi
